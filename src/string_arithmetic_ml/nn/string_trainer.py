...
training_set, testing_set, validation_set = data.split_dataset(data.StringDataset.from_json(master_dir('cache/simple_dataset.json')), .75, .15)
...
validation_loader = DataLoader(testing_set, batch_size=batch_size, shuffle=True)
